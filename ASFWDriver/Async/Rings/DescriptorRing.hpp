 ...
 * - No sentinel descriptor (contexts arm on-demand, see the implementation notes)
...
public:
     ...
     * - No sentinel programming (matches Apple's approach per the implementation notes)
     */
